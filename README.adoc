...
public class DataSetExecutorIt {
    ...
    public static EntityManagerProvider emProvider = instance("executor-it");
...
public class ConnectionHolderIt {
    ...
    public DBUnitRule dbUnitRule = DBUnitRule.
        instance(() -> emProvider.connection());
...
----
    ...
    @Rule
    public DBUnitRule exec1Rule = DBUnitRule.instance("exec1",emProvider1.connection());<1>
...
Now you can use emProvider.connection() to retrieve jdbc connection and emProvider.em() to retrieve underlying entityManager.
